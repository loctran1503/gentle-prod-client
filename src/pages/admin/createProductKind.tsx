...
useEffect(() => {
    ...
    const handleSubmit = async () =>{
        ...
        if(res.data?.adminCreateProductKind.code===400) alert(res.data?.adminCreateProductKind.message)
        if(res.data?.adminCreateProductKind.success) router.push("/admin/dashboard")
    }
  return (
